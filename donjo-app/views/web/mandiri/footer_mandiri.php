...
?>
			...
			<div id='footer'>
				<div id="footer-left">&copy; 2016-<?= date("Y");?>
					<a target="_blank" href="https://opendesa.id">OpenDesa</a> <i class="fa fa-circle" style="font-size: smaller; text-align: center;"></i> <a target="_blank" href="https://github.com/OpenSID/OpenSID">OpenSID</a> <?= AmbilVersi()?> | <strong>STID KBI</strong>
